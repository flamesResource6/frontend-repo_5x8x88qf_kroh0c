...
export default function Experience() {
  return (
    <Section id="experience">
      ...
      <div className="relative border-l border-zinc-200 dark:border-zinc-800 ml-4">
        {experiences.map((ex, i) => (
          ...
          >
            <div className="absolute -left-[6px] w-3 h-3 rounded-full bg-gradient-to-r from-indigo-500 to-cyan-400" />
